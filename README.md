...
[![Overall Progress](https://img.shields.io/badge/Progress-8%2F245%20Labs-red?style=for-the-badge&logo=target)](https://portswigger.net/web-security)
...
| [Cross-Site Scripting (XSS)](#2-cross-site-scripting-30-labs) | 6 / 30 | In Progress|
...
| **Total Academy Progress** | **8 / 245** | **3%** |
...
| Apprentice | DOM XSS in jQuery selector sink using a hashchange event |✅ Pwned | [📝](./writeups/xss/5_DOM_XSS_in_jQuery_selector_sink_using_a_hashchange_event/README.md) |
