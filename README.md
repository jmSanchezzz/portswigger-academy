...
[![Overall Progress](https://img.shields.io/badge/Progress-59%2F270%20Labs-red?style=for-the-badge&logo=target)](https://portswigger.net/web-security)
...
| [20. HTTP Host header attacks](#20-http-host-header-attacks-7-labs) | 2 / 7 | In Progress |
...
| Level | Lab Title | Status | Writeup |
| :--- | :--- | :---: | :---: |
| Apprentice | Unprotected admin functionality | ✅ Pwned | [📝](./writeups/access-control/1_unprotected_admin_functionality/README.md) |
...
| Apprentice | Insecure direct object references | ✅ Pwned | [📝](./writeups/access-control/9_insecure_direct_object_references/README.md) |
...
| Level | Lab Title | Status | Writeup |
| :--- | :--- | :---: | :---: |
| Apprentice | Modifying serialized objects | ✅ Pwned | [📝](./writeups/insecure-deserialization/1_modifying_serialized_objects/README.md) |
...
| Level | Lab Title | Status | Writeup |
| :--- | :--- | :---: | :---: |
| Apprentice | Excessive trust in client-side controls | ✅ Pwned | [📝](./writeups/business-logic-vulnerabilities/1_excessive_trust_in_client_side_controls/README.md) |
| Apprentice | High-level logic vulnerability | ✅ Pwned | [📝](./writeups/business-logic-vulnerabilities/2_high-level_logic_vulnerability/README.md) |
...
| Apprentice | Flawed enforcement of business rules | ✅ Pwned | [📝](./writeups/business-logic-vulnerabilities/4_flawed_enforcement_of_business_rules/README.md) |
...
| Apprentice | Host header authentication bypass | ✅ Pwned | [📝](./writeups/host-header-attacks/2_host_header_authentication_bypass/README.md) |
...
| Apprentice | JWT authentication bypass via flawed signature verification | ✅ Pwned | [📝](./writeups/jwt/2_JWT_authentication_bypass_via_flawed_signature_verification/README.md) |
...
| Apprentice | Exploiting NoSQL operator injection to bypass authentication | ✅ Pwned | [📝](./writeups/nosql-injection/2_exploiting_nosql_operator_injection_to_bypass_authentication/README.md) |
...
| Level | Lab Title | Status | Writeup |
| :--- | :--- | :---: | :---: |
| Apprentice | Exploiting an API endpoint using documentation | ✅ Pwned | [📝](./writeups/api-testing/1_exploiting_an_api_endpoint_using_documentation/README.md) |
...
| Level | Lab Title | Status | Writeup |
| :--- | :--- | :---: | :---: |
| Apprentice | Exploiting path mapping for web cache deception | ✅ Pwned | [📝](./writeups/web-cache-deception/1_exploiting_path_mapping_for_web_cache_deception/README.md) |
